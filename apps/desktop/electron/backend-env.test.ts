...
test('desktop backend PATH adds UniWork-managed bins and missing POSIX sane entries', () => {
...
test('managed Node dirs are empty without a UniWork home', () => {
...
test('normalizeHermesHomeRoot maps profile homes back to the global UniWork root', () => {
  assert.equal(
