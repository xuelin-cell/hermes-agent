...
test('POSIX relaunch gate refuses live and uncertain install markers without executing UniWork', async () => {
...
test('buildSpawnCommand raises the SSH child file limit before execing UniWork', () => {
  const cmd = buildSpawnCommand('/x/hermes', '', { logPath: spawnLogPath(OWNERSHIP_ID, SPAWN_NONCE) })
