...
describe('speaker labels', () => {
  it('the default profile speaks as UniWork in transcripts, not @default', async () => {
    ...
    expect(line).toBe('UniWork: hello room')
  ...
  it('honor friendly identity: Bot Mode title, then display_name, never a stale UniWork', async () => {
    ...
    expect(chat.groupSpeakerLabel('default')).toBe('UniWork')
