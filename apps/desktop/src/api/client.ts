...
export class HermesGateway extends JsonRpcGatewayClient {
  constructor() {
    super({
      closedErrorMessage: 'UniWork gateway connection closed',
      connectErrorMessage: 'Could not connect to UniWork gateway',
      createRequestId: nextId => nextId,
      notConnectedErrorMessage: 'UniWork gateway is not connected',
