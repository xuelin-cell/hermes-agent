...
export const en: Translations = {
  ...
  boot: {
    ready: 'UniWork Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading UniWork settings',
      loadingSessions: 'Loading recent sessions',
      retryingRemoteBackend: 'Reconnecting to the remote UniWork backend…',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting UniWork Desktop…'
    },
    errors: {
      backgroundExited: 'UniWork background process exited.',
      backgroundExitedDuringStartup: 'UniWork background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your UniWork backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateHermes: 'Update UniWork',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting UniWork Desktop.',
    ...
    native: {
      ...
      inputBody: 'UniWork is waiting for your response.',
      turnDoneTitle: 'UniWork finished',
      turnDoneBody: '',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to UniWork defaults?',
    ...
    plugins: {
      ...
      agent: {
        title: 'Agent plugins',
        blurb:
          'Plugins you installed into the UniWork backend — tools, skills, MCP servers, hooks, and slash commands. Portable ones are Agent Plugins packages (skills + MCP bundles that work in other agents too). Toggles apply to new sessions.',
        ...
        updateBackendToManage: 'Update the UniWork backend to manage this plugin from Desktop.',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while UniWork is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'UniWork asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while UniWork was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while UniWork was in the background.'
        }
      },
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let UniWork follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and UniWork can react to yours.',
      tipsTitle: 'In-App Tips',
      tipsDesc:
        'A small bubble pointing at one part of the app, shown occasionally while idle and by UniWork when it helps. Closing one retires it for good.',
      tipsReset: (count: number) => `Bring back ${count} closed ${count === 1 ? 'tip' : 'tips'}`,
      toursTitle: 'Guided Tours',
      toursDesc: 'Let UniWork walk you through the app, dimming the screen and spotlighting each step.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what UniWork is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen UniWork, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      heading: 'UniWork Desktop',
      version: value => `Version ${value}`,
      versionUnavailable: 'Version unavailable',
      bundleOutOfSync: 'App build out of date',
      bundleOutOfSyncDesc:
        'The UniWork runtime was updated, but the desktop app itself is still an older build — new interface features (like Bot Mode) will be missing until it updates. Run the update below to rebuild the app. If that doesn\u2019t clear this warning, reinstall from the latest desktop installer.',
      ...
      automaticUpdatesDesc:
        'UniWork checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading UniWork configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening UniWork.',
    ...
    connections: {
      ...
      intro: 'Manage this device and every UniWork gateway it can reach through remote, SSH, or Cloud connections.',
      stagedNote:
      ...
      updateSkippedCloud: 'Managed by UniWork Cloud',
      kindLocal: 'Local',
      kindRemote: 'Remote gateway',
      kindCloud: 'UniWork Cloud',
      kindSsh: 'SSH',
      kindLocalDesc: 'The UniWork runtime managed by this app.',
      kindRemoteDesc: 'A UniWork gateway reachable over HTTP(S) — LAN, Tailscale, or the internet.',
      kindCloudDesc: 'A hosted instance discovered through your UniWork Cloud account.',
      kindSshDesc: 'A UniWork install reached over SSH.',
      labelTitle: 'Name',
      ...
      headersDesc:
        'Sent with every HTTP and WebSocket request to this gateway — for access proxies such as Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Values are stored encrypted. Headers UniWork manages (Authorization, Cookie, Host…) are ignored.',
      ...
      cloudAddHint:
        'Tip: signing in under UniWork Cloud above discovers your agents automatically — use this form only to register a known instance URL by hand.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a UniWork backend elsewhere. Gateway connections are machine-level; profiles are discovered from the gateways you connect.',
      ...
      localDesc: 'Start a private UniWork backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote UniWork backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'UniWork Cloud',
      cloudDesc: 'Sign in once to UniWork Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'UniWork Cloud',
      cloudSignIn: 'Sign in to UniWork Cloud',
      cloudSignedIn: 'Signed in to UniWork Cloud',
      cloudNeedsSignIn: 'Sign in to UniWork Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your UniWork Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'UniWork Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of UniWork Cloud',
      cloudSignedOutMessage: 'Cleared the UniWork Cloud session.',
      ...
      restartingMessage: 'UniWork Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · UniWork ${version}` : ''}`,
      ...
      sshDesc:
        'UniWork is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshHermesPathTitle: 'UniWork path (optional)',
      ...
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — UniWork found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — UniWork runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'UniWork is not installed on the remote host. Install it there (curl -fsSL https://hermes-agent.nousresearch.com/install.sh | sh) or set the UniWork path.',
      sshErrPlatform:
        'Unsupported remote platform. UniWork Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update UniWork on the remote host before connecting with Desktop SSH.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'A link asked to add this MCP server to UniWork. Review the exact configuration below — it comes from the link, not from UniWork.',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. UniWork runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point UniWork at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
  ...
  starmap: {
    ...
    emptyDesc: 'As UniWork builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart UniWork to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update UniWork to generate pets.',
      backgroundHint: 'You can close this — UniWork will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure UniWork desktop' },
    ...
    hermesActiveSessions: (version, count) => `UniWork ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    remoteOverride: {
      ...
      description: 'Sessions in this profile will run on the remote UniWork you point it at, instead of this computer.',
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent UniWork environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'UniWork did not save that model change.',
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. UniWork will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the UniWork backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from UniWork. Files, git repos, and worktrees stay untouched.',
      ...
      worktreeStaleBackend:
        'Update the UniWork backend to create worktrees over this remote connection — it predates the git worktree API.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting UniWork...',
    placeholderReconnecting: 'Reconnecting to UniWork…',
    ...
    attachUrlDesc: 'UniWork will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask UniWork to open PR',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating UniWork…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting UniWork…',
    ...
    unsupportedMessage: 'This version of UniWork can’t update itself from inside the app.',
    ...
    manualBody: 'You installed UniWork from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'UniWork will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the UniWork desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The UniWork updater takes over in its own window and reopens UniWork automatically when it’s done. Please don’t reopen UniWork yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. UniWork reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then UniWork reopens on its own.',
    errorTitle: 'Update didn’t finish',
    errorBody: 'No worries — nothing was lost. You can try again now.',
    blockerTitle: 'Close local previews to update UniWork?',
    blockerBody:
      'UniWork needs to stop these local previews before updating. This will not modify or delete your files.',
    foreignBlockerTitle: 'Close other processes to update UniWork',
    foreignBlockerBody:
      'UniWork can’t safely close these processes automatically. Close the app, terminal, or service that owns each one, then try the update again.',
    mixedBlockerBody:
      'UniWork can close the local previews listed below. Other processes must be closed manually before the update can continue.',
  ...
  install: {
    ...
    oneTimeTitle: 'UniWork needs a one-time install',
    ...
    setupChoiceTitle: 'Set up UniWork Desktop',
    setupChoiceDesc:
      'Connect this app to a UniWork gateway you already run, or install UniWork locally on this computer.',
    connectExistingTitle: 'Connect to existing UniWork',
    ...
    installLocalTitle: 'Install UniWork locally',
    installLocalDesc: 'Download UniWork, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart UniWork Desktop and try again.',
    remoteSetupTitle: 'Connect to existing UniWork',
    remoteSetupDesc: 'Enter your gateway URL. UniWork Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the UniWork gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/hermes',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that UniWork gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up UniWork Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another UniWork CLI or desktop instance is running. Stop any running UniWork instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The UniWork installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with UniWork Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'UniWork is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting UniWork…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run UniWork',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description:
          'Point UniWork at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — UniWork connects automatically',
    ...
    authorizeThere: 'Authorize UniWork there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize UniWork there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `UniWork Desktop v${version}`,
      backendVersion: version => `Backend v${version}`,
      clientLabel: version => `client v${version}`,
      connectionSsh: host => `SSH: ${host}`,
      connectionRemote: host => `Remote: ${host}`,
      connectionCloud: host => `Cloud: ${host}`,
      connectionCloudTooltip: host => `UniWork Cloud · ${host}`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. UniWork will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'UniWork is restarting...',
      askRestart: 'Ask UniWork to restart the server',
      lookingRestart: taskId => `UniWork is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'UniWork is working in the background. Watch the preview console for progress.',
      ...
      blankPageBody: 'Type an address above to browse, or ask UniWork to open a page.',
      finishedRestarting: message => `UniWork finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'UniWork could not restart the server.',
      stillWorking:
        'UniWork is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'UniWork is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'UniWork gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.hermes/config.yaml). UniWork won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'UniWork needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'UniWork needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart UniWork Desktop to use Save Image.',
    restartToSaveImages: 'Restart UniWork Desktop to save images',
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        title: 'Teach it once',
        text: 'Skills are folders of instructions UniWork loads when the work calls for them.'
      },
      messaging: {
        title: 'UniWork away from your desk',
        text: 'Connect Telegram, Discord, Slack and more — same agent, same memory.'
      },
      artifacts: {
        title: 'Everything UniWork made',
      ...
      profiles: {
        ...
        text: 'Each one is its own UniWork — own keys, own memory, own sessions.'
      },
      'composer-mentions': {
